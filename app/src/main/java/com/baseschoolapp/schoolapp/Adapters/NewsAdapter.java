...
public class NewsAdapter extends ArrayAdapter<NewsDataModel> implements View.OnClickListener{
    ...
    public NewsAdapter(ArrayList<NewsDataModel> data, Context context) {
    ...
    public void onClick(View v) {
        ...
        NewsDataModel dataModel=(NewsDataModel)object;
