...
public class ContactDetailsAdapter extends ArrayAdapter<BasicDetailsDataModel> implements View.OnClickListener {
    ...
    public ContactDetailsAdapter(ArrayList<BasicDetailsDataModel> data, Context context) {
